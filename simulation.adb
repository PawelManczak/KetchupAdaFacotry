...
procedure Simulation is
   ...
   subtype Podprodukt_Type is Integer range 1 .. Number_Of_Products;
   subtype Typ_Zestawow is Integer range 1 .. Number_Of_Assemblies;
   subtype Typ_Konsumenta is Integer range 1 .. Number_Of_Consumers;
   Nazwa_Wyrobu: constant array (Podprodukt_Type) of String(1 .. 6)
   ...
   task type Producent is
      entry Zacznij(Wyrob: in Podprodukt_Type; Czas_Produkcji: in Integer);
   end Producent;
   ...
   task type Bufor is
      entry Przyjmij(Wyrob: in Podprodukt_Type; Numer: in Integer);
      entry Wydaj(Zestaw: in Typ_Zestawow; Numer: out Integer; Wydano: out Boolean);
   end Bufor;

   P: array ( 1 .. Number_Of_Products ) of Producent;
   K: array ( 1 .. Number_Of_Consumers ) of Konsument;
   B: Bufor;
   ...
   task body Producent is
      ...
      PROD: Integer;
   begin
      accept Zacznij(Wyrob: in Podprodukt_Type; Czas_Produkcji: in Integer) do
   ...
   task body Konsument is
      ...
      CZAS: Integer;
      Wydano: Boolean;
      Nazwa_Konsumenta: constant array (1 .. Number_Of_Consumers)
        of String(1 .. 9)
        := ("Pani Asia", "Pan Janek");
   begin
   ...
   task body Bufor is
      ...
      Magazyn: array (Podprodukt_Type) of Integer
        := (0, 0, 0, 0, 0);
      Sklad_Zestawu: array(Typ_Zestawow, Podprodukt_Type) of Integer
        := ((0, 2, 2, 0, 1),
            (1, 2, 0, 0, 1),
            (0, 2, 0, 1, 0));
      ...
      function Mozna_Przyjac(Wyrob: Podprodukt_Type) return Boolean is
      begin
   ...
   begin
      ...
      loop
         select
            accept Przyjmij(Wyrob: in Podprodukt_Type; Numer: in Integer) do
               begin
